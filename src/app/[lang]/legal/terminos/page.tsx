 ...
 * Spanish. The EN locale only translates metadata for SEO and the
 * jurisdictional notice banner.
 */
export async function generateMetadata({
  ...
  return buildPageMetadata({
    title: t(locale, "legal.terminos.metadata.title", { brand: brandConfig.name }),
    description: t(locale, "legal.terminos.metadata.description"),
