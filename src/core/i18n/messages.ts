...
const es: MessageDict = {
  ...
  /* ---------- Safety / quick-exit ---------- */
  "safety.panic.aria": "Salida rápida: ocultar el sitio",
  "safety.panic.tooltip": "Salida rápida — presiona Esc para volver",
  ...
  "auth.badge.menu.settings": "Configuración",
  ...
  "step.details.location.label": "Ubicación",
  "step.details.location.optionalHint": "(opcional)",
  "step.details.location.placeholder": "Elige departamento y ciudad",
  "step.details.location.step.department": "Departamento",
  "step.details.location.step.city": "Ciudad",
  "step.details.location.step.locality": "Localidad / zona",
  "step.details.location.back": "Atrás",
  "step.details.location.searchIn": "Buscar en",
  "step.details.location.empty": "Sin resultados",
  "step.details.location.cityCount": "{count} ciudades",
  "step.details.location.zoneCount": "{count} zonas",
  "step.details.location.anyZone": "Toda la ciudad (sin localidad)",
  ...
  "step.description.gallery.coverCta": "Sube tu portada",
...
const en: MessageDict = {
  ...
  /* ---------- Safety / quick-exit ---------- */
  "safety.panic.aria": "Quick exit: hide the site",
  "safety.panic.tooltip": "Quick exit — press Esc to return",
  ...
  "step.details.location.label": "Location",
  "step.details.location.optionalHint": "(optional)",
  "step.details.location.placeholder": "Pick a department and city",
  "step.details.location.step.department": "Department",
  "step.details.location.step.city": "City",
  "step.details.location.step.locality": "Locality / zone",
  "step.details.location.back": "Back",
  "step.details.location.searchIn": "Search in",
  "step.details.location.empty": "No results",
  "step.details.location.cityCount": "{count} cities",
  "step.details.location.zoneCount": "{count} zones",
  "step.details.location.anyZone": "Whole city (no locality)",
  ...
  "step.description.gallery.coverCta": "Upload your cover",
