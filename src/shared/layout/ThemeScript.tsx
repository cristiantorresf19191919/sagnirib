 ...
 *
 * Four valid themes: `light` (default), `dark`, `bloom` (light violet),
 * `desire` (dark violet).
 *
 ...
 */
const SCRIPT = `(function(){try{var s=localStorage.getItem('biringas:theme');var t=(s==='dark'||s==='light'||s==='desire'||s==='bloom')?s:(window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light');document.documentElement.setAttribute('data-theme',t);}catch(e){}})();`;
