...
export function encodeFilters(filters: ListingsFilters): URLSearchParams {
  ...
  if (filters.priceMin !== undefined) out.set("priceMin", String(filters.priceMin));
  if (filters.priceMax !== undefined) out.set("priceMax", String(filters.priceMax));
...
export function withFilter(
  ...
  switch (key) {
    case "category":
      next.category = value as Category | undefined;
      break;
    case "city":
      next.city = value;
      break;
    case "sex":
      next.sex = value as Sex | undefined;
      break;
  }
