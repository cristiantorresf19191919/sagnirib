...
6. Run gates: `pnpm typecheck`, `pnpm lint`, `pnpm test`, `pnpm build`, plus the relevant audit (`seo:audit`, `design:audit`, `security:audit`, `patterns:audit`, `responsive:audit`).
